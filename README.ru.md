...
Компактное WinUI 3 приложение для Windows, которое отслеживает траты Codex/Codex App по каждому чату и показывает примерную стоимость почти в реальном времени.
